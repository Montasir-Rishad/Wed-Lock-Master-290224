...
$m_query = "SELECT * FROM pm WHERE (sender='$user' AND receiver = '$receiver_mail') OR (receiver ='$user' AND sender = '$receiver_mail');";
    ...
    $m_run = mysqli_query($con, $m_query);
       if(mysqli_num_rows($m_run)>0){
            ...
            ?>
                ...
                <li class="chat2"><h5 style=""><?php echo $us_name; ?>: <b><?php echo $message; ?></b></h5></li>
                <?php  
                        }
                        else{
                ?>
                <li class="chat1"><h5 style=""><?php echo $receiver_name ; ?>: <b><?php echo $message; ?></b></h5></li>
                <?php
